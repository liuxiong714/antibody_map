...
class TestPdfParser:
    ...
    @patch("app.core.pdf_parser._run_ocr_gather", return_value=None)
    @patch("app.core.vl_extractor.extract_with_vision", new_callable=AsyncMock, return_value=None)
    @patch("app.core.pdf_parser.fitz")
    def test_extract_text_with_valid_pdf(self, mock_fitz, mock_vision, mock_ocr):
        mock_doc = MagicMock()
        mock_page = MagicMock()
    ...
    @patch("app.core.pdf_parser._run_ocr_gather")
    @patch("app.core.vl_extractor.extract_with_vision", new_callable=AsyncMock, return_value=None)
    @patch("app.core.pdf_parser.fitz")
    def test_extract_text_with_scanned_pdf(self, mock_fitz, mock_vision, mock_ocr):
        mock_doc = MagicMock()
        mock_page = MagicMock()
    ...
    @patch("app.core.vl_extractor.extract_with_vision", new_callable=AsyncMock, return_value=None)
    @patch("app.core.pdf_parser.fitz")
    def test_extract_text_with_partial_text(self, mock_fitz, mock_vision, mock_ocr):
        mock_doc = MagicMock()
