...
# 34 个省级行政区
# region/abbr 字段来自 app.core.reference_data.china_provinces（唯一数据源），
# 此处硬编码便于零 DB 依赖返回；如引入该模块后可直接据此生成。
PROVINCES = [
    {"code": "110000", "name": "北京市", "region": "中部", "abbr": "京"},
    {"code": "120000", "name": "天津市", "region": "中部", "abbr": "津"},
    {"code": "130000", "name": "河北省", "region": "中部", "abbr": "冀"},
    {"code": "140000", "name": "山西省", "region": "中部", "abbr": "晋"},
    {"code": "150000", "name": "内蒙古自治区", "region": "北部", "abbr": "蒙"},
    {"code": "210000", "name": "辽宁省", "region": "北部", "abbr": "辽"},
    {"code": "220000", "name": "吉林省", "region": "北部", "abbr": "吉"},
    {"code": "230000", "name": "黑龙江省", "region": "北部", "abbr": "黑"},
    {"code": "310000", "name": "上海市", "region": "东部", "abbr": "沪"},
    {"code": "320000", "name": "江苏省", "region": "东部", "abbr": "苏"},
    {"code": "330000", "name": "浙江省", "region": "东部", "abbr": "浙"},
    {"code": "340000", "name": "安徽省", "region": "东部", "abbr": "皖"},
    {"code": "350000", "name": "福建省", "region": "东部", "abbr": "闽"},
    {"code": "360000", "name": "江西省", "region": "东部", "abbr": "赣"},
    {"code": "370000", "name": "山东省", "region": "北部", "abbr": "鲁"},
    {"code": "410000", "name": "河南省", "region": "中部", "abbr": "豫"},
    {"code": "420000", "name": "湖北省", "region": "中部", "abbr": "鄂"},
    {"code": "430000", "name": "湖南省", "region": "南部", "abbr": "湘"},
    {"code": "440000", "name": "广东省", "region": "南部", "abbr": "粤"},
    {"code": "450000", "name": "广西壮族自治区", "region": "南部", "abbr": "桂"},
    {"code": "460000", "name": "海南省", "region": "南部", "abbr": "琼"},
    {"code": "500000", "name": "重庆市", "region": "西部", "abbr": "渝"},
    {"code": "510000", "name": "四川省", "region": "西部", "abbr": "川"},
    {"code": "520000", "name": "贵州省", "region": "南部", "abbr": "贵"},
    {"code": "530000", "name": "云南省", "region": "南部", "abbr": "云"},
    {"code": "540000", "name": "西藏自治区", "region": "西部", "abbr": "藏"},
    {"code": "610000", "name": "陕西省", "region": "中部", "abbr": "陕"},
    {"code": "620000", "name": "甘肃省", "region": "西部", "abbr": "甘"},
    {"code": "630000", "name": "青海省", "region": "西部", "abbr": "青"},
    {"code": "640000", "name": "宁夏回族自治区", "region": "西部", "abbr": "宁"},
    {"code": "650000", "name": "新疆维吾尔自治区", "region": "西部", "abbr": "新"},
    {"code": "710000", "name": "台湾省", "region": "东部", "abbr": "台"},
    {"code": "810000", "name": "香港特别行政区", "region": "南部", "abbr": "港"},
    {"code": "820000", "name": "澳门特别行政区", "region": "南部", "abbr": "澳"},
]
...
@router.get("/dictionary/provinces", response_model=ApiResponse, summary="获取省份字典", description="获取中国34个省级行政区列表，包含代码、名称、分区、简称，用于前端选择器")
